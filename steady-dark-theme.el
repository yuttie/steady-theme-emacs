...
(let (;; Palette
      (base4   "#202020") (base4-256   "#202020")
      (base3   "#303030") (base3-256   "#303030")
      (base2   "#505050") (base2-256   "#505050")
      (base1   "#707070") (base1-256   "#707070")
      (base0   "#b0b0b0") (base0-256   "#b0b0b0")
      (base-1  "#d0d0d0") (base-1-256  "#d0d0d0")
      (base-2  "#f0f0f0") (base-2-256  "#f0f0f0")
      (red     "#e65856") (red-256     "#e65856")
      (orange  "#cd720f") (orange-256  "#cd720f")
      (yellow  "#dcb000") (yellow-256  "#dcb000")
      (green   "#8baa24") (green-256   "#8baa24")
      (cyan    "#26aea1") (cyan-256    "#26aea1")
      (blue    "#2c91ed") (blue-256    "#2c91ed")
      (violet  "#8f68f5") (violet-256  "#8f68f5")
      (magenta "#d255b6") (magenta-256 "#d255b6"))
