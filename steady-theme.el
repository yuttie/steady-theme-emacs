...
(let ((bg  "#ffffff")
  ...
  (custom-theme-set-faces
   ...
   ;; Ediff
   `(ediff-current-diff-A ((t :background "#f6d4d8" :foreground nil :weight bold)))
   `(ediff-current-diff-B ((t :background "#eef5d3" :foreground nil :weight bold)))
   `(ediff-current-diff-C ((t :background "#cbe6f3" :foreground nil :weight bold)))
   `(ediff-odd-diff-A     ((t :background "#f6d4d8" :foreground nil)))
   `(ediff-odd-diff-B     ((t :background "#eef5d3" :foreground nil)))
   `(ediff-odd-diff-C     ((t :background "#cbe6f3" :foreground nil)))
   `(ediff-even-diff-A    ((t :background "#f6d4d8" :foreground nil)))
   `(ediff-even-diff-B    ((t :background "#eef5d3" :foreground nil)))
   `(ediff-even-diff-C    ((t :background "#cbe6f3" :foreground nil)))
   `(ediff-fine-diff-A    ((t :background "#DA6272" :foreground nil)))
